...
public interface Investigator {
     ...
     * it does not contain constructors of any sort
     *
     ...
     * (and NOT the ones that are being implemented by its ancestor in the inheritance chain)
    ...
    /**
     * checks if the given class's direct parent is of an abstract type
     *
     ...
     * No worries: there will be no ambiguity, i.e., two constructors that get in 2 arguments each one of them...
